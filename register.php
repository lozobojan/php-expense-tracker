  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="./backend/auth/register.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Lozinka" name="password" autocomplete="off">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Potvrda lozinke" name="confirm_password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
      ...
      <a href="login.html" class="text-center">Već imaš nalog? Klikni ovdje za prijavu</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
